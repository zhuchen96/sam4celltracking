...
from sam_med3d.utils.click_method import get_next_click3D_torch_2
from sam_med3d.utils.data_loader import Dataset_Union_ALL, Union_Dataloader
from sam_med3d.utils.data_paths import img_datas
...
class BaseTrainer:
    ...
    def batch_forward(self, sam_model, image_embedding, gt3D, low_res_masks, points=None):
        ...
        low_res_masks, iou_predictions = sam_model.mask_decoder(
            ...
            sparse_prompt_embeddings=sparse_embeddings, # (B, .reshape((1,) + sample_array.shape)2, 256)
    ...
    def train_epoch(self, epoch, num_clicks):
        ...
        return epoch_loss, epoch_iou, sum(dice_list) / len(dice_list), pred_list
