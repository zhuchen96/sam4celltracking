...
python tracking_3d_general.py \
    --dataset "TRIF" \
    --image_path "../Data/Fluo-N3DL-TRIF/02_zarr" \
    --detection_path "../Data/Fluo-N3DL-TRIF/02_detection" \
    --res_path "../Data/Fluo-N3DL-TRIF/02_RES" \
    --window_size 64 \
    --init_json_path "../Data/Fluo-N3DL-TRIF/02_centroid.json" \
    --neighbor_thresh 20 \
