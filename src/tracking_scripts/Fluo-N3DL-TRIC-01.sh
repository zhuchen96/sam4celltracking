...
python tracking_3d_general.py \
    --dataset "TRIC" \
    --image_path "../Data/Fluo-N3DL-TRIC/01_zarr" \
    --detection_path "../Data/Fluo-N3DL-TRIC/01_detection" \
    --res_path "../Data/Fluo-N3DL-TRIC/01_RES" \
    --window_size 32 \
    --init_json_path "../Data/Fluo-N3DL-TRIC/01_centroid.json" \
    --neighbor_thresh 15 \
